...
int main(int argc, char **argv) {
    ...
    sk_sp<SkSurface> surface = use_gpu
        ? SkSurfaces::RenderTarget(gr_ctx.get(), skgpu::Budgeted::kNo,
...
// Build (from slughorn/test/benchmark/):
//
// SKIA=~/dev/skia
// g++ slughorn-benchmark-skia.cpp \
//     -I$SKIA \
//     -L$SKIA/out/Release \
//     -std=c++20 -O2 \
//     -Wl,--start-group \
